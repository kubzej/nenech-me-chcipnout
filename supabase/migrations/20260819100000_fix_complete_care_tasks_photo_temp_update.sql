-- Supabase safe-update guards reject UPDATE statements without an explicit
-- WHERE clause. Keep the RPC behavior, but scope the temporary-table photo
-- backfill to the task ids handled by this call.
